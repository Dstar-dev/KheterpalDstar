        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <button 
              ...
              className="hover-trigger inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-secondary hover:bg-secondary/90 text-white font-semibold transition-all shadow-lg shadow-secondary/30"
            >
              Let's Work Together
