...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group backdrop-blur-md bg-card/5 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 border border-border/10 hover:bg-card/10"
    >
